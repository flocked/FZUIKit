...
extension NSPopover {
    ...
    @objc open var isDetachable: Bool {
        get { associatedValue(for: "isDetachable", initial: false) }
    ...
    @objc open var hidesDetachedCloseButton: Bool {
        get { associatedValue(for: "hidesDetachedCloseButton", initial: false) }
        set {
    ...
    public var positioningView: NSView? {
    ...
    @discardableResult
    public func positioningView(_ view: NSView?) -> Self {
    ...
    @discardableResult
    public func preferredEdge(_ preferredEdge: NSRectEdge) -> Self {
