...
public extension NSMenuItem {
    ...
    var visibility: Visibility {
        get { associatedValue(for: "visibility") ?? .automatic }
        set {
    ...
    var updateHandler: ((_ item: NSMenuItem)->())? {
        get { associatedValue(for: "updateHandler") }
        set {
    ...
    var alternateItem: NSMenuItem? {
        get { associatedValue(for: "alternateItem") }
        set {
    ...
    private var isHiddenObservationForAlternateItem: KeyValueObservation? {
        get { associatedValue(for: "isHiddenObservationForAlternateItem") }
