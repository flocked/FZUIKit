...
extension NSDraggingSource where Self: NSObject {
    ...
    public var draggingSourceHandlers: NSDraggingSourceHandlers {
        get { associatedValue(for: "draggingSourceHandlers") ?? .init() }
        set {
