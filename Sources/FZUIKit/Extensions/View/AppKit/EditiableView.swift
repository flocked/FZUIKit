...
public protocol EditiableView: NSView {
    /// A Boolean value indicating whether the user can select the content.
    var isSelectable: Bool { get set }
    /// A Boolean value indicating whether the user can edit the content.
    var isEditable: Bool { get set }
}

extension EditiableView {
    /// A Boolean value indicating whether the user is currently editing the text.
    public var isEditing: Bool {
        isEditable && isFirstResponder
    }
    
    /// A Boolean value indicating whether the user is currently selecting the text.
