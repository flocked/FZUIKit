...
//
    ...
    /*
     extension NSView {
         ...
         @objc internal var dashedBorderColor: NSUIColor? {
         ...
         @objc internal var dashedBorderDashPattern0: CGFloat {
