...
extension NSTableViewRowAction {
    ...
    public convenience init(style: NSTableViewRowAction.Style, title: String, systemSymbol: String, color: NSColor? = nil, handler: @escaping (NSTableViewRowAction, Int) -> Void) {
        self.init(style: style, title: title, handler: handler)
