...
//
    ...
    public extension NSButton {
        ...
        internal var stateContentTintColor: [NSControl.StateValue: NSColor] {
            get { getAssociatedValue(key: "_NSButton_stateContentTintColor", object: self, initialValue: [NSControl.StateValue: NSColor].init()) }
        ...
        internal var stateSymbolConfiguration: [NSControl.StateValue: NSImage.SymbolConfiguration] {
            get { getAssociatedValue(key: "_NSButton_stateSymbolConfiguration", object: self, initialValue: [NSControl.StateValue: NSImage.SymbolConfiguration].init()) }
