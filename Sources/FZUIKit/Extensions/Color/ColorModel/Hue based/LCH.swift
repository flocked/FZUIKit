...
extension ColorModels {
    /// The color components for a color in the CIE LCH color space.
...
public extension ColorModel where Self == ColorModels.LCH {
    /// Returns the color components for a color in the CIE LCH color space.
    static func lch(_ components: [Double]) -> Self {
        .init(components)
    }
    
    /// Returns the color components for a color in the CIE LCH color space.
    static func lch(lightness: Double, chroma: Double, hue: Double, alpha: Double = 1.0) -> Self {
