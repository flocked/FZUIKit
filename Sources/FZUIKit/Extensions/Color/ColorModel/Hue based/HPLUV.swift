...
extension ColorModels {
    /// The color components for a color in the HPLUV color space.
    public struct HPLUV: ColorModel {
        ...
        public var description: String {
            "HPLUV(hue: \(hue), saturation: \(saturation), lightness: \(lightness), alpha: \(alpha))"
        }
...
public extension ColorModel where Self == ColorModels.HPLUV {
    /// Returns the color components for a color in the HPLUV color space.
    static func hpluv(_ components: [Double]) -> Self {
        .init(components)
    }
    
    /// Returns the color components for a color in the HPLUV color space.
    static func hpluv(hue: Double, saturation: Double, lightness: Double, alpha: Double = 1.0) -> Self {
