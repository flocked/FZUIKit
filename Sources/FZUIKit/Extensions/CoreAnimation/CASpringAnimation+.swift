...
//
    ...
    public extension CASpringAnimation {
         ...
         */
        convenience init(dampingRatio: CGFloat, stiffness: CGFloat, mass: CGFloat = 1.0) {
            self.init()
            self.mass = mass
        ...
        /**
         ...
         - parameter mass: The mass "attached" to the spring. The default value of `1.0` rarely needs to be modified.
         */
        convenience init(dampingRatio: CGFloat, response: CGFloat, mass: CGFloat = 1.0) {
            self.init()
            self.mass = mass
            ...
            damping = Rubberband.value(for: unbandedDamping, range: 0 ... 60, interval: 15)
            duration = response
        }

        /// A spring animation with a predefined duration and higher amount of bounce.
        static let bouncy = CASpringAnimation(dampingRatio: 0.7, response: 0.5, mass: 1.0)
         ...
         */
        static func bouncy(duration: CGFloat = 0.5, extraBounce: CGFloat = 0.0) -> CASpringAnimation {
        ...
        static let smooth = CASpringAnimation(dampingRatio: 1.0, response: 0.5, mass: 1.0)
         ...
         */
        static func smooth(duration: CGFloat = 0.5, extraBounce: CGFloat = 0.0) -> CASpringAnimation {
        ...
        static let snappy = CASpringAnimation(dampingRatio: 0.85, response: 0.5, mass: 1.0)
         ...
         */
        static func snappy(duration: CGFloat = 0.5, extraBounce: CGFloat = 0.0) -> CASpringAnimation {
