...
import FZSwiftUtils
    ...
    public extension NSBezierPath {
        ...
        convenience init(roundedRect rect: CGRect, topLeft: CGFloat, topRight: CGFloat, bottomLeft: CGFloat, bottomRight: CGFloat) {
            ...
            appendArc(withCenter: pt, radius: topRight, startAngle: .pi * 1.5, endAngle: 0, clockwise: true)
            ...
            appendArc(withCenter: pt, radius: bottomRight, startAngle: 0, endAngle: .pi * 0.5, clockwise: true)
            ...
            appendArc(withCenter: pt, radius: bottomLeft, startAngle: .pi * 0.5, endAngle: .pi, clockwise: true)
            ...
            pt.y = topLeft
            // add "top-left corner"
            appendArc(withCenter: pt, radius: topLeft, startAngle: .pi, endAngle: .pi * 1.5, clockwise: true)
