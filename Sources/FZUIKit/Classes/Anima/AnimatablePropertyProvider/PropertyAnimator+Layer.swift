...
//
    ...
    public class LayerAnimator<Layer: CALayer>: PropertyAnimator<Layer> {
        ...
        public var sublayers: [LayerAnimator<CALayer>] {
            object.sublayers?.compactMap(\.animator) ?? []
        }
    ...
    public extension LayerAnimator where Layer: CATextLayer {
    ...
    public extension LayerAnimator {
        /**
         The current animation for the property at the specified keypath.

         - Parameter keyPath: The keypath to an animatable property.
         */
        func animation<Value: AnimatableProperty>(for keyPath: WritableKeyPath<LayerAnimator, Value>) -> AnimationProviding? {
            lastAnimationKey = ""
            _ = self[keyPath: keyPath]
            return animations[lastAnimationKey != "" ? lastAnimationKey : keyPath.stringValue]
        }

        internal func _animation<Value: AnimatableProperty>(for keyPath: WritableKeyPath<LayerAnimator, Value>) -> AnimationProviding? {
            _ = self[keyPath: keyPath]
        ...
        /**
         ...
         - Parameter keyPath: The keypath to an animatable property.
         */
        func animationVelocity<Value: AnimatableProperty>(for keyPath: WritableKeyPath<LayerAnimator, Value>) -> Value? {
            var velocity: Value?
