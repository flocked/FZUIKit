...
//
    ...
    public class PropertyAnimator<Object: AnimatablePropertyProvider> {
        ...
        public func animation<Value: AnimatableProperty>(for keyPath: WritableKeyPath<PropertyAnimator, Value>) -> AnimationProviding? {
            animations[keyPath.stringValue]
        }
        ...
        public func animationVelocity<Value: AnimatableProperty>(for keyPath: WritableKeyPath<PropertyAnimator, Value>) -> Value? {
            (animation(for: keyPath) as? any ConfigurableAnimationProviding)?.velocity as? Value
        }
    ...
    extension PropertyAnimator {
        ...
        func setValue<Value: AnimatableProperty>(_ newValue: Value, for keyPath: WritableKeyPath<Object, Value>, completion: (() -> Void)? = nil) {
        ...
        func configurateAnimation<Value>(_ animation: some ConfigurableAnimationProviding<Value>, target: Value, keyPath: WritableKeyPath<Object, Value>, settings: AnimationController.AnimationParameters, completion: (() -> Void)? = nil) {
    ...
    extension PropertyAnimator {
        ...
        func decayAnimation<Val: AnimatableProperty>(for keyPath: WritableKeyPath<Object, Val>) -> DecayAnimation<Val>? {
            animation(for: keyPath) as? DecayAnimation<Val>
        }
    }
