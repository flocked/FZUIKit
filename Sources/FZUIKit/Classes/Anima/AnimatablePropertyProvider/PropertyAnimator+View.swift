...
//
    ...
    public extension AnimatablePropertyProvider where Self: NSUIView {
    ...
    public class ViewAnimator<View: NSUIView>: PropertyAnimator<View> {
        ...
        public var layer: PropertyAnimator<CALayer> {
            #if os(macOS)
                object.wantsLayer = true
            #endif
            return object.optionalLayer!.animator
        }

        /// The property animators for the view's subviews.
        public var subviews: [ViewAnimator<NSUIView>] {
            object.subviews.compactMap(\.animator)
        }
    ...
    public extension ViewAnimator where View: NSUITextField {
        /// The text color of the text field.
        var textColor: NSUIColor? {
            get { self[\.textColor] }
    ...
    public extension ViewAnimator where View: NSUITextView {
    ...
    public extension ViewAnimator where View: NSUIScrollView {
    ...
    extension NSUIView {
        var _gradient: Gradient {
            get { gradient ?? .init(stops: []) }
            set { gradient = newValue }
        }
    }

    public extension ViewAnimator where View: NSUIStackView {
        ...
        public extension ViewAnimator where View: NSImageView {
            ...
            var contentTintColor: NSUIColor? {
        ...
        public extension ViewAnimator where View: ImageView {
            /// The tint color of the image.
        ...
        public extension ViewAnimator where View: GradientView {
            var colors: [NSUIColor] {
                get { object.gradientLayer.animator.colors.compactMap(\.nsUIColor) }
                set { object.gradientLayer.animator.colors = newValue.compactMap { $0.resolvedColor(for: object).cgColor } }
            }

            var locations: [CGFloat] {
                get { object.gradientLayer.animator.locations }
                set { object.gradientLayer.animator.locations = newValue }
            }

            var startPoint: CGPoint {
                get { object.gradientLayer.animator.startPoint }
                set { object.gradientLayer.animator.startPoint = newValue }
            }

            var endPoint: CGPoint {
                get { object.gradientLayer.animator.endPoint }
                set { object.gradientLayer.animator.endPoint = newValue }
            }
        }
    ...
    public extension ViewAnimator {
         ...
         */
        func animation<Value: AnimatableProperty>(for keyPath: WritableKeyPath<ViewAnimator, Value>) -> AnimationProviding? {
        ...
        /**
         ...
         - Parameter keyPath: The keypath to an animatable property.
         */
        func animationVelocity<Value: AnimatableProperty>(for keyPath: WritableKeyPath<ViewAnimator, Value>) -> Value? {
            var velocity: Value?
