...
//
    ...
    public struct DecayFunction: Hashable {
        ...
        public private(set) var one_ln_decelerationRate_1000: Double = 0.0
    ...
    public extension DecayFunction {
        /**
         ...
         */
        static func destination<V>(value: V, velocity: V, decelerationRate: Double = ScrollViewDecelerationRate) -> V where V: VectorArithmetic {
        ...
        /**
         ...
         - Returns: The destination when the decay reaches zero velocity.
         */
        static func destination<V>(value: V, velocity: V, decelerationRate: Double = ScrollViewDecelerationRate, integralizeValue: Bool = false) -> V where V: AnimatableProperty {
            if integralizeValue {
                return V(destination(value: value.animatableData, velocity: velocity.animatableData, decelerationRate: decelerationRate)).scaledIntegral
            }
         ...
         */
        static func velocity<V>(fromValue: V, toValue: V, decelerationRate: Double = ScrollViewDecelerationRate) -> V where V: VectorArithmetic {
        ...
        static func velocity<V>(fromValue: V, toValue: V, decelerationRate: Double = ScrollViewDecelerationRate) -> V where V: AnimatableProperty {
            V(velocity(fromValue: fromValue.animatableData, toValue: toValue.animatableData, decelerationRate: decelerationRate))
        }
         ...
         */
        static func duration<Value: VectorArithmetic>(value: Value, velocity: Value, decelerationRate: Double = ScrollViewDecelerationRate) -> TimeInterval {
            var value = value
        ...
        /**
         ...
         - Returns: The duration required to reach `toValue`.
         */
        static func duration<Value: VectorArithmetic>(fromValue value: Value, toValue: Value, decelerationRate: Double = ScrollViewDecelerationRate) -> TimeInterval {
        ...
        static func duration<Value: AnimatableProperty>(fromValue value: Value, toValue: Value, decelerationRate: Double = ScrollViewDecelerationRate) -> TimeInterval {
            duration(fromValue: value.animatableData, toValue: toValue.animatableData, decelerationRate: decelerationRate)
        }
    }
