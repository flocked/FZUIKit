...
//
    ...
    public class KeyFrameAnimation<Value: AnimatableProperty>: ConfigurableAnimationProviding {
        ...
        var _target: Value.AnimatableData { keyFrames.last?._target ?? _value }
        ...
        public func updateAnimation(deltaTime: TimeInterval) {
            ...
            if let keyFrame = currentKeyFrame {
                if keyFrameAnimation == nil {
                    ...
                    case let .easing(timingFunction, duration):
                    ...
                    case let .decay(decelerationRate):
        ...
        struct KeyFrame {
            enum Mode {
                ...
                var decelerationRate: Double? {
                    switch self {
                    case let .decay(decelerationRate): return decelerationRate
                    default: return nil
                    }
                }
                ...
                var spring: Spring? {
                    switch self {
                    case let .spring(spring): return spring
                    default: return nil
                    }
                }
            ...
            public var target: Value { Value(_target) }
