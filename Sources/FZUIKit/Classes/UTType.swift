...
@available(tvOS, deprecated: 14.0, message: "tvOS 14 provides UTType")
    public struct UTType: Codable, Hashable, CustomStringConvertible, CustomDebugStringConvertible, Sendable {
        ...
        public var preferredMIMEType: String? {
            UTTypeCopyPreferredTagWithClass(
                identifier as CFString,
                UTTagClass.mimeType.rawValue as CFString
            )?.takeRetainedValue() as? String
        }
        ...
        public var tags: [UTTagClass: [String]] {
            ...
            let mimeTypes = spec?[UTTagClass.mimeType.rawValue] as? [String] ?? []
            let extensions = spec?[UTTagClass.filenameExtension.rawValue] as? [String] ?? []
        ...
        /**
         ...
         provided.
         */
        public static func types(tag: String, tagClass: UTTagClass, conformingTo type: Self?) -> [Self] {
...
public extension UTType {
     ...
     */
    init?(tag: String, tagClass: UTTagClass, conformingTo type: Self?) {
        guard let identifier = UTTypeCreatePreferredIdentifierForTag(
