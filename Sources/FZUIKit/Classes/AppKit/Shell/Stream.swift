...
//
    ...
    public extension FileHandle {
        ...
        func readSome(encoding: String.Encoding) -> String? {
        ...
        /// - Parameter encoding: the encoding to use.
        func read(encoding: String.Encoding) -> String {
    ...
    public extension ReadableStream {
        ...
        func lines() -> LazySequence<AnySequence<String>> {
        ...
        var context: ShellContext {
            var context = CustomContext(mainContext)
            context.stdin = self
            return context
        }
    ...
    public extension ReadableStream {
        ...
        func onOutput(_ handler: @escaping (ReadableStream) -> Void) {
