    ...
    public class FinderFileProgress {
        ...
        public var fileSize: DataSize {
            ...
            set { progress.totalUnitCount = Int64(newValue.bytes)
                if fileSize > completedSize && state == .finished {
                    state = .executing
                }
            }
        }
        ...
        /**
         The progress of the process in bytes.
         */
        public var completedSize: DataSize {
            ...
            set {
                if state == .executing || state == .finished {
                    ...
                    if self.completedSize >= fileSize {
                        state = .finished
                    } else {
                        state = .executing
                    }
        ...
        public enum ProgressKind {
            ...
            case uploading
            //// he progress is tracking the receipt of a file
            case receiving
